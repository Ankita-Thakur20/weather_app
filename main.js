...
const fetchWeather=async(e)=>{
    e.preventDefault()
    try {
        const response=await fetch(`https://api.weatherapi.com/v1/current.json?key=84a29b36eebd4c689ea104248240710&q=${input.value}&aqi=yes
            `);
      ...
      card.className = "card my-3 p-4 shadow d-none";
